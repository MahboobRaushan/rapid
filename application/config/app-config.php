...
if($_SERVER['HTTP_HOST']=='localhost')
    {        
        define('APP_BASE_URL', 'http://localhost/rapid/');
    }
else
    {
...
*/
define('APP_ENC_KEY', 'ae30580e48bab0a4a9c339e2e023e9d4');
...
if($_SERVER['HTTP_HOST']=='localhost')
...
else
    {
         ...
         * The username used to connect to the database
         */
        define('APP_DB_USERNAME', 'blocflya_rapid');
        /**
         * The password used to connect to the database
         */
        define('APP_DB_PASSWORD', 'JQ!Cqlz@vF56');
        /**
         * The name of the database you want to connect to
         */
        define('APP_DB_NAME', 'blocflya_rapid');
